...
DEVICENAME                  = '/dev/tty.usbmodem13101'    # Check which port is being used on your controller
...
import time
Motor_offsets = [146, 63, 147, 235]

def Move_motor(id, angle):
    angle = Motor_offsets[id-1]+angle
    try:
